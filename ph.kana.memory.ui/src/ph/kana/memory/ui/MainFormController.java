...
public class MainFormController implements Initializable {
	...
	private void renderAccountCard(Account account) {
		...
		showButton.addEventFilter(MouseEvent.MOUSE_CLICKED, event -> {
		...
		updateMenuItem.addEventHandler(MouseEvent.MOUSE_CLICKED, event -> {
			// TODO: update account
		});
		MenuItem deleteMenuItem = new MenuItem("Delete");
		menuItems.add(deleteMenuItem);
		deleteMenuItem.addEventHandler(MouseEvent.MOUSE_CLICKED, event -> {
			// TODO: delete account
		});
